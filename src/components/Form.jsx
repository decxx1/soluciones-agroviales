    ...
    return (
        <form onSubmit={handleSubmit} method="post" id="contactForm" className="grid grid-cols-1 gap-8 mx-auto max-w-screen-md sm:grid-cols-2">
            ...
            <div className="sm:col-span-2">
                ...
                <textarea id="message" name="mensaje" rows="6" className="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded shadow-sm border border-gray-300 focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Deje su consulta..." required></textarea>
            </div>
